...
export const NextChapterScene = () => {
  ...
  const segs = [
    { label: "提示词", w: 3, bg: "#e2e8f0", fg: "#475569" },
  ...
  return (
    <AbsoluteFill style={{ background: "#f8fafc", fontFamily: FONT, justifyContent: "center", alignItems: "center", opacity: t }}>
      <div style={{ transform: `scale(${scale})`, width: "100%", maxWidth: 1240, padding: "0 60px 120px", textAlign: "center" }}>
        <div style={{ fontSize: 21, fontWeight: 800, letterSpacing: 4, color: "#94a3b8", marginBottom: 16 }}>下一章</div>
        <div style={{ fontSize: 48, fontWeight: 800, color: "#1e293b", marginBottom: 40 }}>深入剖析:context 到底是什么?</div>
        ...
        <div style={{ fontSize: 18, color: "#94a3b8" }}>提示词 · 用户输入 · 每一轮的 tool_use / tool_result —— 这一整条,到底装了什么?</div>
      </div>
    </AbsoluteFill>
  );
};
