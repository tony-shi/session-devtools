...
const FIXTURE_CASES: Record<string, FixtureExpect> = {
  "system-tools-overhead": {
    ...
    expectedSegmentCount: 4 + RULE_MATERIALIZED_SEGMENT_COUNT,
  ...
  "single-tool-call": {
    ...
    expectedSegmentCount: 9 + RULE_MATERIALIZED_SEGMENT_COUNT,
    maxUnexplainedCoverage: 0.01,
  ...
  "multi-turn-human": {
    ...
    expectedSegmentCount: 18 + RULE_MATERIALIZED_SEGMENT_COUNT,
    maxUnexplainedCoverage: 0.01,
    requiredFindingTypes: ["matched", "server_side_attribution", "attribution_only"],
    hasRetryFinding: false,
  },
  "large-tool-output": {
    ...
    expectedSegmentCount: 13 + RULE_MATERIALIZED_SEGMENT_COUNT,
    maxUnexplainedCoverage: 0.01,
    requiredFindingTypes: ["matched", "server_side_attribution", "attribution_only"],
    hasRetryFinding: false,
  },
  ...
  "task-reminder-smoosh": {
    ...
    expectedSegmentCount: 202 + RULE_MATERIALIZED_SEGMENT_COUNT,
    maxUnexplainedCoverage: 0.01,
