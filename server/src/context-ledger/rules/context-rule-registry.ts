...
const SLOT_BINDINGS: Record<string, string[]> = {
  ...
  "claude-code.system-prompt-intro.standard.v1": ["system.section.prelude"],
  "claude-code.system-prompt-intro.output-style.v1": ["system.section.prelude"],
  "claude-code.system-prompt-system-section.v1": ["system.section.system"],
  "claude-code.system-prompt-doing-tasks.v1": ["system.section.doing-tasks"],
  "claude-code.system-prompt-actions-section.v1": ["system.section.actions"],
  "claude-code.system-prompt-using-your-tools.v1": ["system.section.using-tools"],
  "claude-code.system-prompt-output-efficiency.external.v1": ["system.section.output-efficiency"],
  "claude-code.system-prompt-tone-style.external.v1": ["system.section.tone-style"],
  "claude-code.system-prompt-text-output-section.v1": ["system.section.text-output"],
  "claude-code.system-prompt-session-guidance.v1": ["system.section.session-guidance"],
  "claude-code.system-prompt-environment.v1": ["system.section.environment"],
  "claude-code.system-prompt-auto-memory.v1": ["system.section.auto-memory"],
  "claude-code.system-prompt-context-management.v1": [
    "system.section.context-management",
